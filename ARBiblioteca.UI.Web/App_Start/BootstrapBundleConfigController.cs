...
namespace ARBiblioteca.UI.Web.App_Start
{
	public class BootstrapBundleConfig
	{
		public static void RegisterBundles()
		{
            ...
            BundleTable.Bundles.Add(new StyleBundle("~/Content/bootstrapresponsive").Include("~/Content/bootstrap-responsive.css"));
		}
	}
}
